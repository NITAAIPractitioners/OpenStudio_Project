...
def validate_zone_temperature(zone: str, offices: list[str], out_dir: str) -> dict | None:
    ...
    if len(measured_series) > 1:
        ...
        measured = pd.Series()  # Graceful empty fallback instead of IndexError
    ...
    # Infer model label dynamically from aggregator VAL_OUT_DIR.
    # Falls back to 'Temperature' if unset.
