...
if args.schedule_mode == 'ashrae':
    ...
    for sname in space_map.keys():
        ...
        if f_p.exists():
            ...
            space_sch_map[sname] = (sch_ashrae, sch_ashrae)
...
for sname in space_map.keys():
    ...
    pp_inst = openstudio.model.PeopleDefinition(model); pp_inst.setName(f"PeopleDef_{sname}"); pp_inst.setNumberofPeople(peak_cap)
