"""
validate_co2.py — noIdealLoad_model
=========================================
...
CVRMSE_LIMIT  = 30.0 
MBE_LIMIT     = 15.0  # Slightly higher for CO2
...
def validate_zone(zone, offices):
    ...
    # Plot
    plot_path = OUTPUT_DIR / f"noIdealLoad_co2_{zone}.png"
    plot_comparison(
        measured=meas_al, simulated=sim_al,
        title=f"NoIdealLoad CO2 | {zone}", ylabel=YLABEL,
...
def main():
    ...
    print(f"--- noIdealLoad_model: CO2 Validation ---")
    ...
    if results:
        ...
        csv_path = OUTPUT_DIR / "noIdealLoad_co2_metrics.csv"
