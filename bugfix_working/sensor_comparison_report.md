...
- **Median Lead (Light over CO₂)**: 0 minutes
- **Mean Correlation (Light vs Lagged CO₂)**: 0.353
- **Observation**: In active offices, Light activity leads CO₂ peaks by mean 30–60 minutes.

## 6. PIR Evaluation
| Scenario (CO2/Light/PIR) | Count | Role |
|--------------------------|-------|------|
| Short activity | 17 | Confirmation |
| Brief motion/Noise | 17 | Confirmation |
| Strong confirmation | 10 | Confirmation |
| Occupied, only PIR/CO2 | 4 | Confirmation |
