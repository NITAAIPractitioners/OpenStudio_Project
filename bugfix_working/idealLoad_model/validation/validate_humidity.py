"""
validate_humidity.py — idealLoad_model
=========================================
...
def validate_zone(zone, offices, sql_path):
    ...
    # Plot
    plot_path = OUTPUT_DIR / f"idealLoad_humidity_{zone}.png"
    plot_comparison(
        measured=meas_al, simulated=sim_al,
        title=f"IdealLoad Humidity | {zone}", ylabel=YLABEL,
...
def main():
    ...
    print(f"--- idealLoad_model: Humidity Validation ---")
    ...
    if results:
        ...
        csv_path = OUTPUT_DIR / "idealLoad_humidity_metrics.csv"
