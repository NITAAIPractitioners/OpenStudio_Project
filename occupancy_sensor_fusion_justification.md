...
*   **Phase 4: Departure Logic:** As $CO_2$ begins to decay and lights are deactivated, the fused score drops below the 0.35 threshold, providing a clean binary transition to the unoccupied state for nighttime simulation.
