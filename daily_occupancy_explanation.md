...
![Office 448 Validation](./fused_results/plots/448_validation.png)
...
![Office 721 Validation](./fused_results/plots/721_validation.png)
...
![Office 776 Validation](./fused_results/plots/776_validation.png)
...
## 7. Supporting Evidence (Full Audit Trail)
For deep-dive verification of the underlying datasets and metrics, refer to the following repository assets:

*   [**raw_sensor_day_plots/**](./raw_sensor_day_plots/): Full building-wide sensor validation traces.
*   [**original_frozen/fused_results/**](./original_frozen/fused_results/): Baselines and optimized fusion results.
*   [**office_csv_tables/**](./office_csv_tables/): Statistical performance breakdown by zone.
*   [**scratch/daily_lags/**](./scratch/daily_lags/): Correlation plots for the 20min/45min lag derivation.
